...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_ReplaceDialog_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_ReplaceDialog_t qt_meta_stringdata_ReplaceDialog = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_ReplaceDialog[] = {
...
Q_CONSTINIT const QMetaObject ReplaceDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_ReplaceDialog.offsetsAndSizes,
